...
### Lab (60 min): Profile Card Builder
...
### Lecture 2 (next session):
- `useEffect` — running code on render
...
- **Official Docs:** react.dev *(new, excellent)*
- **TypeScript + React:** react-typescript-cheatsheet.netlify.app
- **Vite:** vitejs.dev

### Today's code on the course repo:
`github.com/[your-org]/webdev-course`
→ `module-05/react-intro/`
