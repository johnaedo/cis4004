...
# Week 2: A Brief Overview and History of the Modern Web
...
![Perspectives diagram](../_assets/images/image4.png)
...
![Systems perspective|300](../_assets/images/image5.png)
...
![Software engineering perspective|400](../_assets/images/image6.png)
...
![Zettelkasten](../_assets/images/image7.png)
...
![Memex concept](../_assets/images/image8.jpg)
...
![Memex device](../_assets/images/image9.jpg)
![Memex detail|400](../_assets/images/image10.jpg)
...
![Apple HyperCard](../_assets/images/image11.png)
...
---
### DNS Makes the Internet Discoverable
![TBL proposal annotation|900](../_assets/images/image13.jpg)
...
---
### Browser Marketshare Over Time
![Java applet example](../_assets/images/image33.png)
...
```
HTTP Request:
  GET /swe-432-f22/index.html HTTP/1.1
  Host: kpmoran.cs.gmu.edu
  Accept: text/html
...
![Server-side scripting example 1|600](../_assets/images/image41.jpg)
![Server-side scripting example 2](../_assets/images/image42.jpg)

---

## Server-Side Scripting Architecture

![Server-side scripting site architecture|800](../_assets/images/image43.png)
...
![Server-side framework site architecture](../_assets/images/image43.png)

```
Browser  ←(HTTP Request)→   Web Server  ←→  Database
         ←(HTTP Response)→
         
Presentation tier | Domain logic tier | Persistence tier
```
...
![SPA example|1200](../_assets/images/image45.png)

---

## Single Page App Example

![Single page app example screenshot](../_assets/images/image47.jpg)
...
![JSON|200](../_assets/images/image48.jpg)
...
```
Browser (JavaScript)  ←(HTTP Request)
	→   Web Server  ←→  Database
    ←(HTTP Response JSON)→
...
```
Browser (Front-end framework)         Web Server  ←→  Database
  Component presentation ↕ logic
  Component presentation ↕ logic      Presentation tier
  Component presentation ↕ logic      Domain logic tier
                                       Persistence tier
...
Browser                    Web Servers ←→ Databases
  ←(HTTP Request)→           Microservice A  ←→  DB A
  ←(HTTP Response JSON)→     Microservice B  ←→  DB B
...
![Dynamic web apps architecture](../_assets/images/image50.png)
...
<br/>
![Backend architecture diagram](../_assets/images/image72.png)
![Backend architecture detail](../_assets/images/image73.png)
