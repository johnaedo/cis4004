...
Students build a working Express server from nothing. No starter code. No cloning a repo. The goal is to feel every step — `npm init`, installing a package, writing a route, seeing it respond. MongoDB is introduced at the end as a preview for Lab 2.
